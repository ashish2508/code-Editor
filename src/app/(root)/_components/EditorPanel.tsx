      ...
      <div className="relative bg-gray-700/[0.1] backdrop:blur rounded-xl border border-emerald-700/10 p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className=" font-semibold text-white text-pretty text-sm">
                Text Editor
              </h2>
              <p className="text-xs text-gray-300 font-body underline">
                Write your code in your way
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-sm font-code text-white font-semibold ">
                Share
              </span>
            </motion.button>
          </div>
          ...
          {clerk.loaded && (
            <Editor
              ...
              options={{
                ...
                fontFamily:
                  '"Jet Brains Mono", "Cascadia Code", Consolas, monospace',
                fontLigatures: false,
