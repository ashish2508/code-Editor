...
function EditorPanel() {
  ...
  return (
    <div className="relative">
      <div className="relative bg-stone-700/70 backdrop:blur rounded-xl border border-emerald-700/10 p-6">
      {/*Header */}
              ...
              <div className="flex items-center gap-3 px-3 py-2 bg-emerald-700/[0.05] rounded-lg ring-1 ring-white/5">
                ...
                <div className="flex items-center gap-3 ">
                  <input
                    ...
                    className="w-20 h-1 rounded-lg cursor-pointer accent-emerald-800/60 hover:accent-green-900"
                  />
