  ...
  return (
    <div className="relative items-center flex bg-stone-700/30 backdrop:blur-sm  hover:bg-stone-900 rounded-lg transition-all duration-200 border border-teal-950/50 hover:border-zinc-500"
      ...
      >
        {/* Decoration */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-green-900/5
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-64 bg-stone-700/30 border-amber-950/30 backdrop-blur-md
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden scrollbar-style scroll-smooth  text-cyan-800">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      ${language === lang.id ? "bg-gradient-to-r from-slate-600/5 to-emerald-900/5" : "text-gray-300"}
                      ${isLocked ? "opacity-50" : "bg-gradient-to-r from-slate-600/5 to-emerald-900/5 group-hover:opacity-100 transition-opacity"}
                    `}
                    ...
                    >
                      {/* decorator */}
                      <div
                        className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-green-900/5 rounded-lg
